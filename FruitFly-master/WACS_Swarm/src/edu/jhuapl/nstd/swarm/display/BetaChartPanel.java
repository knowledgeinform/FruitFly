...
/**
 * Displays a history of the Beta count rate
 * 
 * @author fishmsm1
 */
public class BetaChartPanel extends DynamicTimeSeriesChartPanel implements Updateable, ActionListener
{
    ...
    public BetaChartPanel(BeliefManager mgr)
    {
        super(BetaChartPanel.class.getSimpleName());
    ...
    protected void initChartPanel()
    {
        ...
        setSeriesColor("count rate", Color.BLUE.brighter());
...
//        pan.add(getOptionPanel());
    ...
    private JPanel getDataDisplay()
    {
        ...
        pan.add(new JLabel("Current Beta Rate: "));
    ...
    protected void updateData()
    {
        // TEST CODE
//        int[] data = {1};
//        BladewerxStatisticsBelief test = new BladewerxStatisticsBelief(1);
//        _belMgr.put(test);
        // END TEST CODE
