 ...
 * @author humphjc1
 */
public class SimulatedCloudPanel extends javax.swing.JPanel 
{
    BeliefManager m_BeliefManager;
    SearchCanvas m_SearchCanvasPanel;
    
    /**
     * Creates new form SimulatedCloudPanel
     */
    public SimulatedCloudPanel(BeliefManager beliefManager, SearchCanvas searchCanvasPanel) 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jToggleButton1.setText("Define Simulated Cloud");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        if (m_SearchCanvasPanel != null)
        {
            if (jToggleButton1.isSelected())
                m_SearchCanvasPanel.startDefiningSimulatedCloud();
            else
                m_SearchCanvasPanel.stopDefiningSimulatedCloud();
        }
