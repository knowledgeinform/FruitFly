 ...
 * @author humphjc1
 */
public class TargetActualBeliefSatComm extends TargetBaseBelief
{
    /**
   ...
   * Empty constructor.
   */	
  public TargetActualBeliefSatComm(){
    super ();
  }
   ...
   */	
  public TargetActualBeliefSatComm(String agentID, AbsolutePosition pos, Length error){
   ...
   * @param error The error associated with the target position.
   */	
  public TargetActualBeliefSatComm(String agentID, AbsolutePosition pos, Length error, String targetID){
    super(agentID, pos, error, targetID);
  }
  

  public TargetActualBeliefSatComm(String agentID, AbsolutePosition pos, Length error, String targetID, Date timestamp){
