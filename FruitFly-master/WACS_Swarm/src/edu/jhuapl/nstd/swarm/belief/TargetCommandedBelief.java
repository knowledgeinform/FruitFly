 ...
 * @author humphjc1
 */
public class TargetCommandedBelief extends TargetBaseBelief
{

    /**
   * The unique name for this belief type.
   */  
  public static final String BELIEF_NAME = "TargetCommandedBelief";

  public TargetCommandedBelief()
  {
    super ();
  }
   ...
   */	
  public TargetCommandedBelief(String agentID, AbsolutePosition pos, Length error)
  {
   ...
   * @param error The error associated with the target position.
   */	
  public TargetCommandedBelief(String agentID, AbsolutePosition pos, Length error, String targetID)
  {
        super (agentID, pos, error, targetID);
  }
  
  public TargetCommandedBelief(String agentID, AbsolutePosition pos, Length error, String targetID, Date time)
  {
