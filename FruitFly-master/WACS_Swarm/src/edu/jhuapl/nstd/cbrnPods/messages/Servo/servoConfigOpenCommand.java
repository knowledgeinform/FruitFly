 ...
 * @author humphjc1
 */
public class servoConfigOpenCommand extends cbrnPodCommand
{
    private char dutyVal = 0;
    private char index = 0;

    public servoConfigOpenCommand()
    {
        super(cbrnSensorTypes.SENSOR_SERVO, cbrnPodCommand.SERVO_CONFIG_OPEN, 3);
    }
    
    /**
     * @param newDuty duty value
     */
    public servoConfigOpenCommand(char index, char newDuty)
    {
        super(cbrnSensorTypes.SENSOR_SERVO, cbrnPodCommand.SERVO_CONFIG_OPEN, 3);
        setIndex (index);
        setDuty (newDuty);
