 ...
 * @author humphjc1
 */
public class bridgeportStatisticsMessage extends cbrnPodMsg
{    
    /**
    ...
    public bridgeportStatisticsMessage() {
        super(cbrnSensorTypes.SENSOR_BRIDGEPORT, cbrnPodMsg.BRIDGEPORT_STATISTICS, 0);
    }
