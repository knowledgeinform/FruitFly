 ...
 * @author humphjc1
 */
public class servoIncPwmCommand extends cbrnPodCommand
{
    private char dutyVal = 0;
    private char index = 0;

    public servoIncPwmCommand()
    {
        super(cbrnSensorTypes.SENSOR_SERVO, cbrnPodCommand.SERVO_INC_PWM, 3);
    }
     ...
     */
    public servoIncPwmCommand(char index, char newDuty)
    {
        super(cbrnSensorTypes.SENSOR_SERVO, cbrnPodCommand.SERVO_INC_PWM, 3);
        setIndex (index);
        setDuty (newDuty);
