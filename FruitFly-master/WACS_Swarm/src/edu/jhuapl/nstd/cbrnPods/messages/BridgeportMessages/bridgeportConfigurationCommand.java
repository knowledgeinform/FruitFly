 ...
 * @author humphjc1
 */
public class bridgeportConfigurationCommand extends cbrnPodCommand
{
    byte[] m_Data;
    
    public bridgeportConfigurationCommand()
    {
         super(cbrnSensorTypes.SENSOR_BRIDGEPORT, cbrnPodCommand.BRIDGEPORT_CONFIGURATION, 0);
    }
    
    public bridgeportConfigurationCommand(byte[] newData)
    {
         super(cbrnSensorTypes.SENSOR_BRIDGEPORT, cbrnPodCommand.BRIDGEPORT_CONFIGURATION, 0);
         setData (newData);
    }
