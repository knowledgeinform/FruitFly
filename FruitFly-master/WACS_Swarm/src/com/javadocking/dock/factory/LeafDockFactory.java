 ...
 * <li>{@link WacsLineDock} for {@link DockingMode#HORIZONTAL_TOOLBAR}.</li>
 * <li>{@link WacsLineDock} for {@link DockingMode#VERTICAL_TOOLBAR}.</li>
 * <li>{@link GridDock} for {@link DockingMode#MINIMIZE_GRID}.</li>
 * <li>{@link WacsLineDock} for {@link DockingMode#HORIZONTAL_MINIMIZE}.</li>
 * <li>{@link WacsLineDock} for {@link DockingMode#VERTICAL_MINIMIZE}.</li>
 * <li>{@link TabDock} for {@link DockingMode#TAB}.</li>
 * <li>{@link SingleDock} for {@link DockingMode#SINGLE}.</li>
 * <li>{@link WacsLineDock} for {@link DockingMode#HORIZONTAL_LINE}.</li>
 * <li>{@link WacsLineDock} for {@link DockingMode#VERTICAL_LINE}.</li>
 * <li>{@link GridDock} for {@link DockingMode#GRID}.</li>
 * </ul>
 * </p>
 * 
 * MODIFIED FOR WACS TO MAKE 
 *  ALL LineDock MADE FROM WacsLineDock AND 
 *  ALL TabDock MADE FROM WacsTabDock
 * 
 * @author Heidi Rakels
 */
public class LeafDockFactory implements DockFactory 
{
	...
	protected boolean 	useLastDockingMode		= true;
	...
	{	
		...
		if (useLastDockingMode)
		{
			switch (dockable.getLastDockingMode())
			{
				...
				case DockingMode.HORIZONTAL_TOOLBAR:
					return new WacsLineDock(WacsLineDock.ORIENTATION_HORIZONTAL, false, DockingMode.HORIZONTAL_TOOLBAR, DockingMode.VERTICAL_TOOLBAR);
				case DockingMode.VERTICAL_TOOLBAR:
					return new WacsLineDock(WacsLineDock.ORIENTATION_VERTICAL, false, DockingMode.HORIZONTAL_TOOLBAR, DockingMode.VERTICAL_TOOLBAR);
				case DockingMode.MINIMIZE_GRID:
					return new GridDock(DockingMode.MINIMIZE_GRID);
				case DockingMode.HORIZONTAL_MINIMIZE:
					return new WacsLineDock(WacsLineDock.ORIENTATION_HORIZONTAL, false, DockingMode.HORIZONTAL_MINIMIZE, DockingMode.VERTICAL_MINIMIZE);
				case DockingMode.VERTICAL_MINIMIZE:
					return new WacsLineDock(WacsLineDock.ORIENTATION_VERTICAL, false, DockingMode.HORIZONTAL_MINIMIZE, DockingMode.VERTICAL_MINIMIZE);
				...
				case DockingMode.HORIZONTAL_LINE:
					WacsLineDock lineDock = new WacsLineDock(WacsLineDock.ORIENTATION_HORIZONTAL, false);
					lineDock.setRealSizeRectangle(false);
					return lineDock;
				case DockingMode.VERTICAL_LINE:
					lineDock = new WacsLineDock(WacsLineDock.ORIENTATION_VERTICAL, false);
					lineDock.setRealSizeRectangle(false);
					return lineDock;
		...
		if (dockable instanceof CompositeDockable)
		{
			...
			{
				WacsLineDock lineDock = new WacsLineDock(WacsLineDock.ORIENTATION_VERTICAL, false);
				lineDock.setRealSizeRectangle(false);
				return lineDock;
			}
		...
		if ((dockableObject != null) && (dockableObject instanceof Component))
		{
			...
			if ((dockingModes & DockingMode.HORIZONTAL_LINE) != 0)
			{
				return new WacsLineDock(WacsLineDock.ORIENTATION_HORIZONTAL, false);
			}
			if ((dockingModes & DockingMode.VERTICAL_LINE) != 0)
			{
				return new WacsLineDock(WacsLineDock.ORIENTATION_VERTICAL, false);
			}
			if ((dockingModes & DockingMode.GRID) != 0)
			{
				return new GridDock();
