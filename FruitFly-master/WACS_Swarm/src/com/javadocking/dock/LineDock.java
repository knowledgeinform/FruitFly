...
public class LineDock extends JPanel implements LeafDock
{
	...
	protected static final String PROPERTY_DOCKABLE_IDS 			= "dockableIds";
	...
	protected static final int 	priorityBorder 					= 10;
	/** The relative offset of the priority rectangle. */
	protected static final double priorityRectangleRelativeOffset	= 2.0 / 8.0;
	...
	protected List				childDockables				= new ArrayList();
	/** With this handle all the dockables of this dock can be dragged. */
	protected DockHeader			handle;
	...
	protected int					horizontalDockingMode		= DockingMode.HORIZONTAL_LINE;
	/** The docking mode for a dockable that is docked in this line dock, 
	 * if the line dock has a vertical orientation (ORIENTATION_VERTICAL). */
	protected int					verticalDockingMode			= DockingMode.VERTICAL_LINE;
	/** True if composite dockables may be added to this dock, when it is not empty. False otherwise. */
	protected boolean				addCompositeDockables							= true;
	 ...
	 * We keep it as field because we don't want to create every time a new rectangle. */
	protected Rectangle			helpRectangle				= new Rectangle();
	...
	protected Point 				dockablePanelPosition       = new Point();
	/** This is the position of the dockable. 
	 * We keep it as field because we don't want to create every time a new point. */
	protected Point 				dockablePosition       		= new Point();
	...
	protected JPanel				dockablePanel;
	...
	protected boolean				realSizeRectangle			= true;
	 ...
	 */
	protected void setLastDockingMode(Dockable dockable)
	{
