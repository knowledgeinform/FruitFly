 ...
 * </p>
 * 
 * MODIFIED FOR WACS:  Made all private fields protected
 * 
 * @author Heidi Rakels.
 */
public class SplitDock extends JPanel implements CompositeDock
{
	...
	protected CompositeDockFactory 	compositeChildDockFactory;
	...
	protected Rectangle 				priorityRectangle 				= new Rectangle(); 
	/** The support for handling the docking events. */
	protected DockingEventSupport		dockingEventSupport				= new DockingEventSupport();
	...
	protected Dock 					ghostSingleChild;
	 ...
	 * We only want to lose the listeners when dragging is finished. This is only used with dynamic dragging. */
	protected JSplitPane 				ghostSplitPane;
	...
	protected boolean					removeLastEmptyChild = true;
	 ...
	 * @throws 	IllegalStateException 		If this dock is not empty.
	 */
	protected void setDocks(Dock leftDock, Dock rightDock, int orientation, int dividerLocation)
	{
		// Check if this dock is empty.
		if (!isEmpty())
		{
	 ...
	 */
	protected boolean sameElements(List firstList, List secondList)
	{
	 ...
	 */
	protected static int getDockingMode(int dockPosition)
	{
		switch (dockPosition)
		{
			case Position.TOP:
