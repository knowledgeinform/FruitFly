...
public class XYPlot extends Plot implements ValueAxisPlot, Pannable, Zoomable,
    ...
    public void draw(Graphics2D g2, Rectangle2D area, Point2D anchor,
        ...
        Set<Rectangle2D> labels = new HashSet<Rectangle2D>();
        for (int i = 0; i < this.renderers.size(); i++) {
            drawRangeMarkers(g2, dataArea, i, Layer.BACKGROUND, labels);
        }
        ...
        Set<Rectangle2D> l2 = new HashSet<Rectangle2D>();
        for (int i = 0; i < this.renderers.size(); i++) {
            drawRangeMarkers(g2, dataArea, i, Layer.FOREGROUND, l2);
        }
    ...
    protected void drawRangeMarkers(Graphics2D g2, Rectangle2D dataArea,
                                    int index, Layer layer, Set<Rectangle2D> labels) {
        ...
        if (markers != null && axis != null)
        {
            if (r instanceof AbstractXYItemRenderer)
            {
                AbstractXYItemRenderer rend = (AbstractXYItemRenderer) r;
                rend.safeDrawRangeMarkers(g2, this, axis, markers, labels, dataArea);
            }
            else
            {
                Iterator iterator = markers.iterator();
